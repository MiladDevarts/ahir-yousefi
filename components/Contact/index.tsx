            ...
            <form action="#" className='flex flex-col gap-y-6 w-full lg:w-1/2'>
                <div>
                    ...
                    <div className='rounded-2xl  flex items-center w-full h-16 px-4 bg-[#1B1B1B]'>
                        ...
                        <input type="text" className='rounded-2xl w-10/12 h-full px-4 font-light text-lg bg-transparent text[#A6A6A6] focus:border-none focus:outline-none text-white' placeholder='Jason' />
                    </div>
                </div>
                <div>
                    ...
                    <div className='rounded-2xl  flex items-center w-full h-16 px-4 bg-[#1B1B1B]'>
                        ...
                        <input type="email" id='email' className='rounded-2xl text-white w-10/12 h-full px-4 font-light text-lg bg-transparent text[#A6A6A6] focus:border-none focus:outline-none' placeholder='unreal@outlook.com' />
                    </div>
                </div>
                <div>
                    <label htmlFor="Message" className='block mb-4 text-lg font-medium'>Message</label>
                    <textarea rows={200} id='Message' className='rounded-2xl text-white flex items-center w-full h-32 p-4 bg-[#1B1B1B]'>
                    </textarea>
                </div>
                <input type='submit' value={"Send message"} className='rounded-2xl flex justify-center items-center w-full h-[70px] px-4 font-semibold bg-white text-black hover:cursor-pointer' />
            </form>
