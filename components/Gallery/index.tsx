    ...
    return (
        <section className='container my-44'>
            ...
            <div className='grid grid-cols-3 lg:grid-cols-12 grid-rows-3 lg:grid-rows-2 gap-x-7 gap-y-6'>
                ...
                <div data-aos="fade-down" data-aos-duration="1000" className='rounded-[30px] w-full h-[150px] lg:h-[350px] bg-white row-start-3 row-end-4 col-start-1 col-end-4 lg:row-start-2 lg:row-end-3 lg:col-span-12 bg-cover bg-center' style={{ backgroundImage: `url('/images/gallery/5.jpg')` }}></div>
            </div>
        </section>
    )
}
